...
class CompletableReactiveSource(@NonNull private val source: Completable) : LiveData<Optional<Nothing>>() {
    ...
    private val observerReference = AtomicReference<Observer<in Optional<Nothing>>>()
    ...
    override fun observe(owner: LifecycleOwner, observer: Observer<in Optional<Nothing>>) {
